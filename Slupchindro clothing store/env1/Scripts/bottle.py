#!C:\Users\Artem\Documents\Учеба\3 курс\Инструментальные средства разработки ПО\Лабораторные\LR2-4\Slupchindro clothing store\Slupchindro clothing store\env1\Scripts\python.exe
# -*- coding: utf-8 -*-
"""
