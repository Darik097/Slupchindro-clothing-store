#!C:\Users\Artem\Documents\Учеба\3 курс\Инструментальные средства разработки ПО\Лабораторные\LR2-4\Slupchindro clothing store\Slupchindro clothing store\env\Scripts\python.exe
# -*- coding: utf-8 -*-
"""
